...
if (!modules[0].ALPHION_BRAND || !modules[0].DefaultGoalManager || !modules[0].DefaultScheduleManager || !modules[0].buildCompactionPolicy || !modules[1].Agent || !modules[2].DeterministicRoutingPolicy || !modules[3].SystemPromptComposer || modules[4].DESKTOP_IPC_SCHEMA_VERSION !== 1 || !modules[5].createWebUiServer) throw new Error("A public v0.8.0 subpath export is missing.");
