...
if (!modules[0].ALPHION_BRAND || !modules[0].DefaultGoalManager || !modules[0].DefaultScheduleManager || !modules[0].buildCompactionPolicy || modules[0].IMAGE_ATTACHMENT_LIMITS?.perMessage !== 8 || !modules[1].Agent || !modules[2].DeterministicRoutingPolicy || !modules[3].SystemPromptComposer || modules[4].DESKTOP_IPC_SCHEMA_VERSION !== 1 || !modules[5].createWebUiServer) throw new Error("A public v0.10.2 subpath export is missing.");
