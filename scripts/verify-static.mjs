...
assert(packageJson.version === "0.9.0", "package.json must be version 0.9.0");
...
assert(/output:\s*release\/v0\.9\.0/u.test(electronBuilder), "Electron packaging must use a versioned ignored output directory");
