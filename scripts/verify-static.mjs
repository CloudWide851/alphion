...
assert(packageJson.version === "0.10.1", "package.json must be version 0.10.1");
...
assert(/output:\s*release\/v0\.10\.1/u.test(electronBuilder), "Electron packaging must use a versioned ignored output directory");
