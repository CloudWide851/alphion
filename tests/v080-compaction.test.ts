...
function model(contextWindowTokens: number): ModelDescriptor {
  return { id: `model_${contextWindowTokens}`, providerKind: "deepseek", model: "deepseek-v4-flash", capabilities: { streaming: true, tools: true, promptCaching: false, reasoning: false, vision: false }, contextWindowTokens };
}
...
function providerProfile(): ProviderProfile {
  return { schemaVersion: 3, id: "summary", name: "Summary", kind: "deepseek", presetId: "deepseek", model: "deepseek-v4-flash", protocol: "chat-completions", auth: { mode: "none" }, capabilities: { streaming: true, tools: false, promptCaching: false, reasoning: false, vision: false }, revision: 1, active: true };
}
