...
test("SQLite v5 records domain identity and creates a recoverable v4 backup", async () => {
  ...
  try {
    ...
    database.exec("DROP TABLE schedule_commands; DROP TABLE schedule_executions; DROP TABLE schedules; DROP TABLE goal_commands; DROP TABLE goal_revisions; DROP TABLE goals; DROP TABLE compaction_records; DROP TABLE vault_legacy_state; DROP TABLE device_vault_secrets; DROP TABLE device_vault_metadata; DROP TABLE collaboration_run_budgets; DROP TABLE collaboration_messages; DROP INDEX sessions_domain; ALTER TABLE sessions DROP COLUMN project_id; ALTER TABLE sessions DROP COLUMN domain_id; PRAGMA user_version = 4;");
    database.close();
